...
exports.createForTrade = exports.listByTrade = void 0;
const MessageService = __importStar(require("./message.service"));
const listByTrade = async (req, res) => {
    try {
...
exports.listByTrade = listByTrade;
const createForTrade = async (req, res) => {
    try {
        const userId = req.user?.userId;
        if (!userId)
            return res.status(401).json({ message: 'Unauthorized' });
...
exports.createForTrade = createForTrade;
